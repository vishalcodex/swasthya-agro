...
import com.codex.swasthyaagro.fragment.FaqFragment;
import com.codex.swasthyaagro.fragment.NotificationFragment;
import com.codex.swasthyaagro.fragment.ProfileFragment;
import com.codex.swasthyaagro.fragment.ReferEarnFragment;
import com.codex.swasthyaagro.fragment.WebViewFragment;
...
import com.codex.swasthyaagro.helper.Utils;
import com.codex.swasthyaagro.ui.CircleTransform;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (session.isUserLoggedIn()) {
            ...
            Picasso.get()
                    ...
                    .fit()
                    .centerInside()
                    .placeholder(R.drawable.swasthyaagro)
                    .error(R.drawable.swasthyaagro)
                    .transform(new CircleTransform())
                    .into(imgProfile);
        }
